  ...
  switch (action.type) {
    ...
    case REQUEST_ROBOTS_SUCCESS:
      return Object.assign({}, state, {
        requestedRobots: action.payload,
        isPending: false,
      });
...
export const selectAvatars = (
  state = intialStateSelectAvatars,
  action = {},
) => {
  switch (action.type) {
    case CHANGE_SELECTED_AVATARS:
...
export const createRobotPage = (
  state = intialStateCreateRobotPage,
  action = {},
) => {
  switch (action.type) {
...
export const allRobots = (state = intialStateAllRobots, action = {}) => {
  switch (action.type) {
    ...
    case DELETE_ROBOT:
      return Object.assign({}, state, {
        robots: state.robots.filter(
          (robot) => robot.lastName !== action.payload,
        ),
      });
