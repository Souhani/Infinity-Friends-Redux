...
describe("searcheRobots", () => {
  ...
  it("should return the intial state", () => {
    expect(reducers.searcheRobots(intialStateSearchField, {})).toEqual(
      intialStateSearchField,
    );
  });
  it("should handle CHANGE_SEARCH_FIELD", () => {
    expect(
      reducers.searcheRobots(intialStateSearchField, {
...
describe("requestRobots", () => {
  ...
  it("should return the intial state", () => {
    expect(reducers.requestRobots(intialStateGetRobots, {})).toEqual(
      intialStateGetRobots,
    );
  });
  it("should handle REQUEST_ROBOTS_PENDING", () => {
    expect(
      reducers.requestRobots(intialStateGetRobots, {
...
describe("createRobots", () => {
  ...
  it("should handle CHANGE_NAME_FIELD", () => {
    expect(
      reducers.createRobots(intialStateCreateRobots, {
  ...
  it("it should handle CHANGE_NICKNAME_FIELD", () => {
    ...
    expect(reducers.createRobots(intialStateCreateRobots, action)).toEqual({
      name: "",
      nickname: "ali",
    });
  });
...
describe("createRobotPage", () => {
  ...
  it("should return the intial state", () => {
    expect(reducers.createRobotPage(intialStateCreateRobotPage, {})).toEqual({
      createPage: false,
    });
  });
  it("should handle CHANGE_ROBOT_PAGE", () => {
    ...
    expect(
      reducers.createRobotPage(intialStateCreateRobotPage, action),
...
describe("allRobots", () => {
  ...
  it("should return intial state", () => {
    expect(reducers.allRobots(intialStateAllRobots, {})).toEqual({
      robots: [],
    });
  });
  ...
  it("should handle GET_ALL_ROBOTS", () => {
    ...
    expect(reducers.allRobots(intialStateAllRobots, action)).toEqual({
      robots: [
        {
          id: 123,
          firstName: "Jhon",
  ...
  it("should handle DELETE_ROBOT", () => {
    ...
    expect(reducers.allRobots(state, action)).toEqual({
      robots: [
        {
          id: 456,
          firstName: "targiyan",
